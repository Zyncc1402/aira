            ...
            <div className="flex w-screen container justify-between mt-6 mb-6">
                ...
                <Sheet>
                    <div className="flex gap-3">
                        ...
                        <SheetTrigger
                            className="bg-primary text-primary-foreground hover:bg-primary/90 flex items-center justify-center px-3 py-2 rounded-lg font-semibold">
                            Filters
                        </SheetTrigger>
                    </div>
                                            ...
                                            <div className="flex items-center space-x-2">
                                                ...
                                                >
                                                    <div className="flex gap-2">
                                                        White
                                                        <div
                                                            className="h-4 w-4 rounded-full bg-white border-[1px] border-black"></div>
                                                    </div>
                                                </Label>
                                            </div>
                                            <div className="flex items-center space-x-2">
